...
-- fixed elm 0.19 shadowing errors
-- looks like parts have been moved to https://github.com/elm/color
-- except the tango COLORS
-- also that module is not released
